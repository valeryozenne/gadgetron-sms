/** \file   GenericCheckSizeDataRefSBGadget.h
...
namespace Gadgetron {
    ...
    class EXPORTGADGETSEXAMPLELIB GenericCheckSizeDataRefSBGadget : public GenericReconDataBase
    {
    public:
        GADGET_DECLARE(GenericCheckSizeDataRefSBGadget);

        typedef GenericReconDataBase BaseClass;
        typedef hoNDKLT< std::complex<float> > KLTType;

        GenericCheckSizeDataRefSBGadget();
        ~GenericCheckSizeDataRefSBGadget();
