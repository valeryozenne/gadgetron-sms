/** \file   GenericChangeSizeTo8Gadget.h
...
namespace Gadgetron {
    ...
    class EXPORTGADGETSEXAMPLELIB GenericChangeSizeTo8Gadget : public GenericReconDataBase
    {
    public:
        GADGET_DECLARE(GenericChangeSizeTo8Gadget);

        typedef GenericReconDataBase BaseClass;
        typedef hoNDKLT< std::complex<float> > KLTType;

        GenericChangeSizeTo8Gadget();
        ~GenericChangeSizeTo8Gadget();
