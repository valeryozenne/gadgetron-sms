/** \file   GenericReconCartesianMultibandSliceGrappaGadget.h
...
namespace Gadgetron {
    ...
    template <typename T>
    class EXPORTGADGETSEXAMPLELIB GenericReconCartesianMultibandSliceGrappaObj
    {
    public:

        GenericReconCartesianMultibandSliceGrappaObj() {}
        virtual ~GenericReconCartesianMultibandSliceGrappaObj()
        {
...
namespace Gadgetron {
    ...
    class EXPORTGADGETSEXAMPLELIB GenericReconCartesianMultibandSliceGrappaGadget : public GenericReconGadget
    {
    public:
        GADGET_DECLARE(GenericReconCartesianMultibandSliceGrappaGadget);

        typedef GenericReconGadget BaseClass;
        typedef Gadgetron::GenericReconCartesianMultibandSliceGrappaObj< std::complex<float> > ReconObjType;

        GenericReconCartesianMultibandSliceGrappaGadget();
        ~GenericReconCartesianMultibandSliceGrappaGadget();
