...
//GenericReconDataBase
    ...
    class EXPORTGADGETSEXAMPLELIB GenericCheckSizeGadget : public Gadget2<IsmrmrdReconData, IsmrmrdReconData>
    {
    public:
        GADGET_DECLARE(GenericCheckSizeGadget);

        typedef Gadget2<IsmrmrdReconData, IsmrmrdReconData> BaseClass;
        typedef hoNDKLT< std::complex<float> > KLTType;

        GenericCheckSizeGadget();
        ~GenericCheckSizeGadget();
    ...
    protected:
        ...
        virtual int process(Gadgetron::GadgetContainerMessage< IsmrmrdReconData >* m1, Gadgetron::GadgetContainerMessage< IsmrmrdReconData >* m2);
