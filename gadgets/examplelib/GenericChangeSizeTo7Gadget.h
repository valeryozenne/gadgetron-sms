/** \file   GenericChangeSizeTo7Gadget.h
...
namespace Gadgetron {
    ...
    class EXPORTGADGETSEXAMPLELIB GenericChangeSizeTo7Gadget : public GenericReconDataBase
    {
    public:
        GADGET_DECLARE(GenericChangeSizeTo7Gadget);

        typedef GenericReconDataBase BaseClass;
        typedef hoNDKLT< std::complex<float> > KLTType;

        GenericChangeSizeTo7Gadget();
        ~GenericChangeSizeTo7Gadget();
