...
namespace Gadgetron {
    ...
    template class EXPORTGADGETSEXAMPLELIB GenericReconBase<IsmrmrdReconData>;
    template class EXPORTGADGETSEXAMPLELIB GenericReconBase<IsmrmrdImageArray>;
    template class EXPORTGADGETSEXAMPLELIB GenericReconBase<ISMRMRD::ImageHeader>;
