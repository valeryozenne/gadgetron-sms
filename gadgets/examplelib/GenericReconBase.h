...
namespace Gadgetron {
    ...
    template <typename T> 
    class EXPORTGADGETSEXAMPLELIB GenericReconBase : public Gadget1<T>
    {
    public:
    ...
    class EXPORTGADGETSEXAMPLELIB GenericReconDataBase :public GenericReconBase < IsmrmrdReconData >
    {
    public:
    ...
    class EXPORTGADGETSEXAMPLELIB GenericReconImageBase :public GenericReconBase < IsmrmrdImageArray >
    {
    public:
    ...
    class EXPORTGADGETSEXAMPLELIB GenericReconImageHeaderBase :public GenericReconBase < ISMRMRD::ImageHeader >
    {
    public:
