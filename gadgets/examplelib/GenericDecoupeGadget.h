...
namespace Gadgetron {
    ...
    class EXPORTGADGETSEXAMPLELIB GenericDecoupeGadget : public GenericReconDataBase
    {
    public:
        GADGET_DECLARE(GenericDecoupeGadget);

        typedef GenericReconDataBase BaseClass;
        typedef hoNDKLT< std::complex<float> > KLTType;

        GenericDecoupeGadget();
        ~GenericDecoupeGadget();
