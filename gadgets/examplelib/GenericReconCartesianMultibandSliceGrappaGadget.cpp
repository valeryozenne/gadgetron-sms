...
#include "GenericReconCartesianMultibandSliceGrappaGadget.h"
...
namespace Gadgetron {
    ...
    GenericReconCartesianMultibandSliceGrappaGadget::GenericReconCartesianMultibandSliceGrappaGadget() : BaseClass()
    {
    }

    GenericReconCartesianMultibandSliceGrappaGadget::~GenericReconCartesianMultibandSliceGrappaGadget()
    {
    }

    int GenericReconCartesianMultibandSliceGrappaGadget::process_config(ACE_Message_Block* mb)
    {
    ...
    int GenericReconCartesianMultibandSliceGrappaGadget::process(Gadgetron::GadgetContainerMessage< IsmrmrdReconData >* m1)
    {
        if (perform_timing.value()) { gt_timer_local_.start("GenericReconCartesianMultibandSliceGrappaGadget::process"); }
        ...
        for (size_t e = 0; e < recon_bit_->rbit_.size(); e++)
        {
            ...
            if (recon_bit_->rbit_[e].ref_)
            {
                ...
                if (perform_timing.value()) { gt_timer_.start("GenericReconCartesianMultibandSliceGrappaGadget::make_ref_coil_map"); }
                ...
                if (perform_timing.value()) { gt_timer_.start("GenericReconCartesianMultibandSliceGrappaGadget::prepare_down_stream_coil_compression_ref_data"); }
                ...
                if (perform_timing.value()) { gt_timer_.start("GenericReconCartesianMultibandSliceGrappaGadget::perform_coil_map_estimation"); }
                ...
                if (perform_timing.value()) { gt_timer_.start("GenericReconCartesianMultibandSliceGrappaGadget::perform_calib"); }
            ...
            if (recon_bit_->rbit_[e].data_.data_.get_number_of_elements() > 0)
            {
                ...
                if (perform_timing.value()) { gt_timer_.start("GenericReconCartesianMultibandSliceGrappaGadget::perform_unwrapping"); }
                this->perform_unwrapping(recon_bit_->rbit_[e], recon_obj_[e], e);
                if (perform_timing.value()) { gt_timer_.stop(); }

                // ---------------------------------------------------------------

                if (perform_timing.value()) { gt_timer_.start("GenericReconCartesianMultibandSliceGrappaGadget::compute_image_header"); }
                ...
                if (perform_timing.value()) { gt_timer_.start("GenericReconCartesianMultibandSliceGrappaGadget::send_out_image_array"); }
                ...
                if (send_out_gfactor.value() && recon_obj_[e].gfactor_.get_number_of_elements()>0 && (acceFactorE1_[e] * acceFactorE2_[e]>1))
                {
                    ...
                    if (perform_timing.value()) { gt_timer_.start("GenericReconCartesianMultibandSliceGrappaGadget::send_out_image_array, gfactor"); }
    ...
    void GenericReconCartesianMultibandSliceGrappaGadget::prepare_down_stream_coil_compression_ref_data(const hoNDArray< std::complex<float> >& ref_src, hoNDArray< std::complex<float> >& ref_coil_map, hoNDArray< std::complex<float> >& ref_dst, size_t e)
    {
        try
        {
...
#pragma omp for
        ...
        {
            GADGET_THROW("Errors happened in GenericReconCartesianMultibandSliceGrappaGadget::prepare_down_stream_coil_compression_ref_data(...) ... ");
        }
    }

    void GenericReconCartesianMultibandSliceGrappaGadget::perform_calib(IsmrmrdReconBit& recon_bit, ReconObjType& recon_obj, size_t e)
    {
        try
        {
...
#pragma omp parallel for default(none) private(ii) shared(src, dst, recon_obj, e, num, ref_N, ref_S, ref_RO, ref_E1, ref_E2, RO, E1, E2, dstCHA, srcCHA, convKRO, convKE1, convKE2, kRO, kNE1, kNE2) if(num>1)
        ...
        {
            GADGET_THROW("Errors happened in GenericReconCartesianMultibandSliceGrappaGadget::perform_calib(...) ... ");
        }
    }

    void GenericReconCartesianMultibandSliceGrappaGadget::perform_unwrapping(IsmrmrdReconBit& recon_bit, ReconObjType& recon_obj, size_t e)
    {
        try
        {
            ...
            if (effective_acce_factor > 1)
            {
                ...
                if (this->verbose.value()) GDEBUG_STREAM("GenericReconCartesianMultibandSliceGrappaGadget, grappaKernelCompensationFactor*snr_scaling_ratio : " << grappaKernelCompensationFactor*snr_scaling_ratio);
            }
...
#pragma omp for
        ...
        {
            GADGET_THROW("Errors happened in GenericReconCartesianMultibandSliceGrappaGadget::perform_unwrapping(...) ... ");
        }
    }

    void GenericReconCartesianMultibandSliceGrappaGadget::compute_snr_map(ReconObjType& recon_obj, hoNDArray< std::complex<float> >& snr_map)
    {
        try
        {
            typedef std::complex<float> T;
    ...
    int GenericReconCartesianMultibandSliceGrappaGadget::close(unsigned long flags)
    {
        GDEBUG_CONDITION_STREAM(true, "GenericReconCartesianMultibandSliceGrappaGadget - close(flags) : " << flags);
    ...
    GADGET_FACTORY_DECLARE(GenericReconCartesianMultibandSliceGrappaGadget)
}
