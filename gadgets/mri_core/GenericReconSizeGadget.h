...
namespace Gadgetron {
    ...
    class EXPORTGADGETSMRICORE GenericReconSizeGadget : public GenericReconDataBase
    {
    public:
        GADGET_DECLARE(GenericReconSizeGadget);

        typedef GenericReconDataBase BaseClass;

        GenericReconSizeGadget();
        ~GenericReconSizeGadget();
