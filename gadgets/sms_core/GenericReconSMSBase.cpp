...
void GenericReconSMSBase::load_epi_data()
{
    ...
    for (s = 0; s < lNumberOfSlices_  ; s++)
    {
        ...
        //std::cout <<" size(corrneg,0) "<<  size(corrneg,0) <<  " size(corrneg,1)  " <<  size(corrneg,1) <<  std::endl;
        ...
        //std::cout <<" size(corrneg_all,0) "<<  size(corrneg_all,0) <<  " size(corrneg_all,1)  " <<  size(corrneg_all,1) <<  std::endl;


        //   std::cout << corrneg_all_.col(s) << std::endl;
        //   std::cout << corrpos_all_.col(s)<< std::endl;
...
void GenericReconSMSBase::prepare_epi_data(size_t e)
{
    ...
    std::cout <<  " PUTTTAINNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNN"  << std::endl;*/
    ...
    std::cout <<  " 2 fois plus de PUTTTAINNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNN"  << std::endl;*/
