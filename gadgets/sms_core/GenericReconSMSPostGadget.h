...
namespace Gadgetron {
    ...
    protected:
        ...
        virtual void undo_blip_caipi_shift(hoNDArray< std::complex<float> >& sb_8D, hoNDArray< ISMRMRD::AcquisitionHeader > & headers_sb, size_t e, bool undo_absolute, bool is_mb, bool compute_header);
