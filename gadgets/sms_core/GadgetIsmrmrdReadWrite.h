...
namespace Gadgetron{
    ...
    class EXPORTGADGETSSMSCORE GadgetIsmrmrdAcquisitionMessageWriter : public GadgetMessageWriter
    {
    ...
    */
    class EXPORTGADGETSSMSCORE GadgetIsmrmrdAcquisitionMessageReader : public GadgetMessageReader
    {
    ...
    class EXPORTGADGETSSMSCORE GadgetIsmrmrdWaveformMessageWriter : public GadgetMessageWriter
    {
    ...
    class EXPORTGADGETSSMSCORE GadgetIsmrmrdWaveformMessageReader : public GadgetMessageReader
    {
