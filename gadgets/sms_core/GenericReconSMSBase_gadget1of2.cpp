...
GenericReconSMSBase_gadget1of2::GenericReconSMSBase_gadget1of2() : BaseClass()
{
}

GenericReconSMSBase_gadget1of2::~GenericReconSMSBase_gadget1of2()
{
}

int GenericReconSMSBase_gadget1of2::process_config(ACE_Message_Block* mb)
{
...
std::vector<unsigned int> GenericReconSMSBase_gadget1of2::sort_index(std::vector<unsigned int> array)
{
...
int GenericReconSMSBase_gadget1of2::process(Gadgetron::GadgetContainerMessage< IsmrmrdReconData >* m1)
{
...
void GenericReconSMSBase_gadget1of2::save_4D_data(hoNDArray<float >& input, std::string name, std::string encoding_number)
{
...
void GenericReconSMSBase_gadget1of2::save_4D_data(hoNDArray< std::complex<float> >& input, std::string name, std::string encoding_number)
{
    size_t X1 = input.get_size(0);
    size_t X2 = input.get_size(1);
    size_t X3 = input.get_size(2);
...
void GenericReconSMSBase_gadget1of2::apply_relative_phase_shift(hoNDArray< std::complex<float> >& data, bool is_positive )
{
...
void GenericReconSMSBase_gadget1of2::apply_relative_phase_shift_test(hoNDArray< std::complex<float> >& data, bool is_positive )
{
    // à définir dans SMS Base car c'est aussi utilisé dans SMSPostGadget
    // vecteur_in_E1_direction=exp(1i*([1:1:size(reconSB,2)]- 1*center_k_space_sample   )*2*pi/PE_shift*(nband-1)) ;
    //  test=repmat( vecteur_in_E1_direction ,[ size(reconSB,1) 1 size(reconSB,3) size(reconSB,4) size(reconSB,5) size(reconSB,6)]  );
...
void GenericReconSMSBase_gadget1of2::get_header_and_position_and_gap(hoNDArray< std::complex<float> >& data, hoNDArray< ISMRMRD::AcquisitionHeader > headers_)
{
    size_t E1 = data.get_size(1);
...
void GenericReconSMSBase_gadget1of2::save_8D_containers_as_4D_matrix_with_a_loop_along_the_6th_dim_stk(hoNDArray< std::complex<float> >& input, std::string name, std::string encoding_number)
{
    size_t RO = input.get_size(0);
    size_t E1 = input.get_size(1);
    size_t E2 = input.get_size(2);
...
void GenericReconSMSBase_gadget1of2::save_4D_with_STK_5(hoNDArray< std::complex<float> >& input, std::string name, std::string encoding_number)
{
    size_t RO = input.get_size(0);
    size_t E1 = input.get_size(1);
...
void GenericReconSMSBase_gadget1of2::save_4D_with_STK_6(hoNDArray< std::complex<float> >& input, std::string name, std::string encoding_number)
{
    size_t RO = input.get_size(0);
    size_t E1 = input.get_size(1);
    size_t CHA = input.get_size(2);
...
void GenericReconSMSBase_gadget1of2::save_4D_with_STK_7(hoNDArray< std::complex<float> >& input, std::string name, std::string encoding_number)
{
    size_t RO = input.get_size(0);
    size_t E1 = input.get_size(1);
    size_t CHA = input.get_size(2);
...
void GenericReconSMSBase_gadget1of2::save_4D_8D_kspace(hoNDArray< std::complex<float> >& input, std::string name, std::string encoding_number)
{
    size_t RO = input.get_size(0);
    size_t E1 = input.get_size(1);
    size_t E2 = input.get_size(2);
...
std::vector<unsigned int> GenericReconSMSBase_gadget1of2::map_interleaved_acquisitions(int number_of_slices, bool no_reordering )
{
...
std::vector< std::vector<unsigned int> > GenericReconSMSBase_gadget1of2::get_map_slice_single_band(int MB_factor, int lNumberOfStacks, std::vector<unsigned int> order_of_acquisition_mb, bool no_reordering)
{
    std::vector< std::vector<unsigned int> > output(lNumberOfStacks_, std::vector<unsigned int>(MB_factor, 0));
    //output.zeros();
...
void GenericReconSMSBase_gadget1of2::show_size(hoNDArray< std::complex<float> >& input, std::string name)
{
    size_t RO = input.get_size(0);
    size_t E1 = input.get_size(1);
    size_t E2 = input.get_size(2);
    ...
    GDEBUG_STREAM("GenericReconSMSBase_gadget1of2 - "<<  name << ": [X1 X2 X3 X4 X5 X6 X7 X8 ] - [" << RO << " " << E1 << " " << E2 << " " << CHA << " " << X5 <<  " " << X6 << " " << X7 << " " << X8  << "]");
}

void GenericReconSMSBase_gadget1of2::load_epi_data()
{
    ///------------------------------------------------------------------------
...
int GenericReconSMSBase_gadget1of2::CheckComplexNumberEqualInVector(hoNDArray< std::complex<float> >& input , arma::cx_fvec  input_arma)
{
...
int GenericReconSMSBase_gadget1of2::CheckComplexNumberEqualInMatrix(hoNDArray< std::complex<float> >& input , arma::cx_fmat  input_arma)
{
...
void GenericReconSMSBase_gadget1of2::compute_mean_epi_nav(hoNDArray< std::complex<float> >& input,  hoNDArray< std::complex<float> >& output_no_exp ,  hoNDArray< std::complex<float> >& output )
{
...
void GenericReconSMSBase_gadget1of2::compute_mean_epi_arma_nav(arma::cx_fcube &input,  arma::cx_fmat& output_no_exp,  arma::cx_fmat& output)
{
...
void GenericReconSMSBase_gadget1of2::reorganize_arma_nav(arma::cx_fmat &data, std::vector<unsigned int> indice)
{
...
void GenericReconSMSBase_gadget1of2::reorganize_nav(hoNDArray< std::complex<float> >& data, std::vector<unsigned int> indice)
{
    size_t RO=data.get_size(0);
...
void GenericReconSMSBase_gadget1of2::create_stacks_of_nav(hoNDArray< std::complex<float> >& data, hoNDArray< std::complex<float> >& new_stack)
{
    size_t RO=data.get_size(0);
    size_t SLC=data.get_size(1);
...
//sur les données single band
void GenericReconSMSBase_gadget1of2::create_stacks_of_arma_nav(arma::cx_fmat &data, arma::cx_fcube &new_stack)
{
    size_t RO=size(data,0);
    size_t SLC=size(data,1);
...
void GenericReconSMSBase_gadget1of2::prepare_epi_data(size_t e, size_t E1, size_t E2, size_t CHA )
{
    std::stringstream os;
    os << "_encoding_" << e;
...
void GenericReconSMSBase_gadget1of2::define_usefull_parameters(IsmrmrdReconBit &recon_bit, size_t e)
{
...
bool GenericReconSMSBase_gadget1of2::detect_first_repetition(IsmrmrdReconBit &recon_bit)
{
    ...
    for (size_t ii=0; ii<recon_bit.data_.headers_.get_number_of_elements(); ii++)
    {
        ...
        {
            GDEBUG_STREAM("GenericReconSMSBase_gadget1of2 - this is not the first repetition)");
            is_first_repetition=false;
            break;
        }
    }

    if (is_first_repetition) {GDEBUG_STREAM("GenericReconSMSBase_gadget1of2 - this is the first repetition)"); }

    return is_first_repetition;

}

bool GenericReconSMSBase_gadget1of2::detect_single_band_data(IsmrmrdReconBit &recon_bit)
{
    ...
    for (size_t ii=0; ii<recon_bit.data_.headers_.get_number_of_elements(); ii++)
    {
        ...
        {
            GDEBUG_STREAM("GenericReconSMSBase_gadget1of2 - Single band data (assuming splitSMSGadget is ON)");
            is_single_band=true;
            break;
        }
    }

    if (is_single_band==false) {GDEBUG_STREAM("GenericReconSMSBase_gadget1of2 - Multiband band data (assuming splitSMSGadget is ON)");}

    return is_single_band;

}

void GenericReconSMSBase_gadget1of2::define_usefull_parameters_simple_version(IsmrmrdReconBit &recon_bit, size_t e)
{
...
int GenericReconSMSBase_gadget1of2::get_reduced_E1_size(size_t start_E1 , size_t end_E1 , size_t acc )
{
    int output;
...
void GenericReconSMSBase_gadget1of2::apply_ghost_correction_with_STK6_old(hoNDArray< std::complex<float> >& data,  hoNDArray< ISMRMRD::AcquisitionHeader > headers_ , size_t acc, bool undo, bool optimal )
{
    size_t RO = data.get_size(0);
    size_t E1 = data.get_size(1);
    size_t E2 = data.get_size(2);
...
void GenericReconSMSBase_gadget1of2::apply_ghost_correction_with_arma_STK6(hoNDArray< std::complex<float> >& data,  hoNDArray< ISMRMRD::AcquisitionHeader > headers_ , size_t acc, bool undo, bool optimal , std::string msg)
{
    size_t RO = data.get_size(0);
    size_t E1 = data.get_size(1);
    size_t E2 = data.get_size(2);
    ...
    //GDEBUG_STREAM("GenericReconSMSBase_gadget1of2 - EPI stk6 data array  : [RO E1 E2 CHA N S SLC] - [" << msg << " " << RO << " " << E1 << " " << E2 << " " << CHA << " " << MB << " " << STK << " " << N << " " << S << "]");
    ...
    //GDEBUG_STREAM("GenericReconSMSBase_gadget1of2 - EPI stk6 data array  HEAD : [E1 E2 N S SLC] - [" << msg << " " << hE1 << " " << hE2<< " " << hN << " " << hS <<" " << hSLC << "]");
...
void GenericReconSMSBase_gadget1of2::do_fft_for_ref_scan(hoNDArray< std::complex<float> >& data)
{
    hoNDFFT<float>::instance()->fft1c(data);
}


void GenericReconSMSBase_gadget1of2::apply_ghost_correction_with_STK6_open(hoNDArray< std::complex<float> >& data,  hoNDArray< ISMRMRD::AcquisitionHeader > headers_ , size_t acc, bool undo, bool optimal , bool ifft , std::string msg)
{
    size_t RO = data.get_size(0);
    size_t E1 = data.get_size(1);
    size_t E2 = data.get_size(2);
...
void GenericReconSMSBase_gadget1of2::apply_ghost_correction_with_STK6_gpu(hoNDArray< std::complex<float> >& data,  hoNDArray< ISMRMRD::AcquisitionHeader > headers_ , size_t acc, bool undo, bool optimal , bool ifft , std::string msg)
{
    size_t RO = data.get_size(0);
    size_t E1 = data.get_size(1);
    size_t E2 = data.get_size(2);
    ...
    GDEBUG_STREAM("GenericReconSMSBase_gadget1of2 - EPI stk6 data array  : [RO E1 E2 CHA MB STK N S] - [" << msg << " " << RO << " " << E1 << " " << E2 << " " << CHA << " " << MB << " " << STK << " " << N << " " << S << "]");
...
void GenericReconSMSBase_gadget1of2::apply_ghost_correction_with_STK6(hoNDArray< std::complex<float> >& data,  hoNDArray< ISMRMRD::AcquisitionHeader > headers_ , size_t acc, bool undo, bool optimal , bool ifft , std::string msg)
{
    size_t RO = data.get_size(0);
    size_t E1 = data.get_size(1);
    size_t E2 = data.get_size(2);
...
void GenericReconSMSBase_gadget1of2::apply_ghost_correction_with_STK7(hoNDArray< std::complex<float> >& data,  hoNDArray< ISMRMRD::AcquisitionHeader > headers_ , size_t acc, bool optimal )
{
    size_t RO = data.get_size(0);
    size_t E1 = data.get_size(1);
    size_t E2 = data.get_size(2);
...
void GenericReconSMSBase_gadget1of2::apply_absolute_phase_shift(hoNDArray< std::complex<float> >& data, bool is_positive)
{    
...
GADGET_FACTORY_DECLARE(GenericReconSMSBase_gadget1of2)
}
