...
namespace Gadgetron {
    ...
    template class EXPORTGADGETSSMSCORE GenericReconBase<IsmrmrdReconData>;
    template class EXPORTGADGETSSMSCORE GenericReconBase<IsmrmrdImageArray>;
    template class EXPORTGADGETSSMSCORE GenericReconBase<ISMRMRD::ImageHeader>;
