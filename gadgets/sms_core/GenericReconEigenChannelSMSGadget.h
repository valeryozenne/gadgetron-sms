/** \file   GenericReconEigenChannelSMSGadget.h
...
namespace Gadgetron {
    ...
    class EXPORTGADGETSSMSCORE GenericReconEigenChannelSMSGadget : public GenericReconDataBase
    {
    public:
        GADGET_DECLARE(GenericReconEigenChannelSMSGadget);

        typedef GenericReconDataBase BaseClass;
        typedef hoNDKLT< std::complex<float> > KLTType;

        GenericReconEigenChannelSMSGadget();
        ~GenericReconEigenChannelSMSGadget();
    ...
    protected:
        ...
        virtual void reformat_to_7D_for_testing(hoNDArray< std::complex<float> >& input, hoNDArray< std::complex<float> > &output);
        virtual void reformat_to_8D_for_testing(hoNDArray< std::complex<float> >& input, hoNDArray< std::complex<float> > &output);
