...
namespace Gadgetron {
    ...
    template <typename T> 
    class EXPORTGADGETSSMSCORE GenericReconBase : public Gadget1<T>
    {
    public:
    ...
    class EXPORTGADGETSSMSCORE GenericReconKSpaceReadoutBase :public GenericReconBase < ISMRMRD::AcquisitionHeader >
    {
    public:
    ...
    class EXPORTGADGETSSMSCORE GenericReconDataBase :public GenericReconBase < IsmrmrdReconData >
    {
    public:
    ...
    class EXPORTGADGETSSMSCORE GenericReconImageBase :public GenericReconBase < IsmrmrdImageArray >
    {
    public:
    ...
    class EXPORTGADGETSSMSCORE GenericReconImageHeaderBase :public GenericReconBase < ISMRMRD::ImageHeader >
    {
    public:
