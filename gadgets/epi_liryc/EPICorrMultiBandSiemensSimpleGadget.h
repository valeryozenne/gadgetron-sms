#ifndef EPICorrMultiBandSiemensSimpleGadget_H
#define EPICorrMultiBandSiemensSimpleGadget_H
...
namespace Gadgetron{
  ...
  class  EXPORTGADGETS_EPI_LIRYC EPICorrMultiBandSiemensSimpleGadget :
  public Gadget2<ISMRMRD::AcquisitionHeader,hoNDArray< std::complex<float> > >
    {
    public:
      EPICorrMultiBandSiemensSimpleGadget();
      virtual ~EPICorrMultiBandSiemensSimpleGadget();
    ...
    protected:
      ...
      int get_stack_number_from_gt_numerotation(int slice);
       ...
       void fonction_qui_sauvegarde_en_memoire_et_somme_les_corrections(int slice, int Nx_local, arma::fvec tvec_local );
      ...
      int flag_average_ghost_niquist_correction_are_available;
...
#endif //EPICorrMultiBandSiemensSimpleGadget_H
