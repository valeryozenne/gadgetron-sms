#ifndef EPICorrMultiBandSiemensGadget_H
#define EPICorrMultiBandSiemensGadget_H
...
namespace Gadgetron{
  ...
  class  EXPORTGADGETS_EPI_LIRYC EPICorrMultiBandSiemensGadget :
  public Gadget2<ISMRMRD::AcquisitionHeader,hoNDArray< std::complex<float> > >
    {
    public:
      EPICorrMultiBandSiemensGadget();
      virtual ~EPICorrMultiBandSiemensGadget();
...
#endif //EPICorrMultiBandSiemensGadget_H
