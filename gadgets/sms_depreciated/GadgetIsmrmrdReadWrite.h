...
namespace Gadgetron{
    ...
    class EXPORTGADGETSSMSDEPRECIATED GadgetIsmrmrdAcquisitionMessageWriter : public GadgetMessageWriter
    {
    ...
    */
    class EXPORTGADGETSSMSDEPRECIATED GadgetIsmrmrdAcquisitionMessageReader : public GadgetMessageReader
    {
    ...
    class EXPORTGADGETSSMSDEPRECIATED GadgetIsmrmrdWaveformMessageWriter : public GadgetMessageWriter
    {
    ...
    class EXPORTGADGETSSMSDEPRECIATED GadgetIsmrmrdWaveformMessageReader : public GadgetMessageReader
    {
