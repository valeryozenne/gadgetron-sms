/** \file   GenericReconCartesianSliceGrappav0Gadget.h
...
namespace Gadgetron {
    ...
    class EXPORTGADGETSSMSDEPRECIATED GenericReconCartesianSliceGrappav0Gadget : public GenericReconSMSv0Base
    {
    public:
        GADGET_DECLARE(GenericReconCartesianSliceGrappav0Gadget);

        typedef GenericReconSMSv0Base BaseClass;
        typedef Gadgetron::GenericReconCartesianGrappaObj< std::complex<float> > ReconObjType;

        GenericReconCartesianSliceGrappav0Gadget();
        ~GenericReconCartesianSliceGrappav0Gadget();
