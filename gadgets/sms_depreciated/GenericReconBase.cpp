...
namespace Gadgetron {
    ...
    template class EXPORTGADGETSSMSDEPRECIATED GenericReconBase<IsmrmrdReconData>;
    template class EXPORTGADGETSSMSDEPRECIATED GenericReconBase<IsmrmrdImageArray>;
    template class EXPORTGADGETSSMSDEPRECIATED GenericReconBase<ISMRMRD::ImageHeader>;
