...
namespace Gadgetron {
    ...
    template <typename T> 
    class EXPORTGADGETSSMSDEPRECIATED GenericReconBase : public Gadget1<T>
    {
    public:
    ...
    class EXPORTGADGETSSMSDEPRECIATED GenericReconKSpaceReadoutBase :public GenericReconBase < ISMRMRD::AcquisitionHeader >
    {
    public:
    ...
    class EXPORTGADGETSSMSDEPRECIATED GenericReconDataBase :public GenericReconBase < IsmrmrdReconData >
    {
    public:
    ...
    class EXPORTGADGETSSMSDEPRECIATED GenericReconImageBase :public GenericReconBase < IsmrmrdImageArray >
    {
    public:
    ...
    class EXPORTGADGETSSMSDEPRECIATED GenericReconImageHeaderBase :public GenericReconBase < ISMRMRD::ImageHeader >
    {
    public:
