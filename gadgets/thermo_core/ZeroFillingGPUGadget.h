...
namespace Gadgetron {
    ...
    class EXPORTGADGETSTHERMOCORE ZeroFillingGPUGadget : public GenericReconImageBase
    {
    public:
        GADGET_DECLARE(ZeroFillingGPUGadget);

        typedef GenericReconImageBase BaseClass;

        ZeroFillingGPUGadget();
        ~ZeroFillingGPUGadget();
