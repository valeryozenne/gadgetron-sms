...
#include "ApplySliceOptimalPhaseShiftGadget.h"
...
ApplySliceOptimalPhaseShiftGadget::ApplySliceOptimalPhaseShiftGadget() {
}

ApplySliceOptimalPhaseShiftGadget::~ApplySliceOptimalPhaseShiftGadget() {
}

int ApplySliceOptimalPhaseShiftGadget::process_config(ACE_Message_Block *mb)
{
...
int ApplySliceOptimalPhaseShiftGadget::process(GadgetContainerMessage<ISMRMRD::AcquisitionHeader> *m1, GadgetContainerMessage<hoNDArray<std::complex<float> > > *m2)
{
    ...
    else if (is_acq_single_band)
    {
        ...
        if(is_first_scan_in_slice && slice==indice_sb(0))
        {
...
void ApplySliceOptimalPhaseShiftGadget::get_multiband_parameters(ISMRMRD::IsmrmrdHeader h)
{
...
int ApplySliceOptimalPhaseShiftGadget::get_blipped_factor(int numero_de_slice)
{
...
int ApplySliceOptimalPhaseShiftGadget::get_stack_number_from_gt_numerotation(int slice)
{
...
int ApplySliceOptimalPhaseShiftGadget::get_stack_number_from_spatial_numerotation(int slice)
{
...
void ApplySliceOptimalPhaseShiftGadget::deal_with_inline_or_offline_situation(ISMRMRD::IsmrmrdHeader h)
{
...
GADGET_FACTORY_DECLARE(ApplySliceOptimalPhaseShiftGadget)
}
