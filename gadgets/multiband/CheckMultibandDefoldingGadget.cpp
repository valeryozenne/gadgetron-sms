...
#include "CheckMultibandDefoldingGadget.h"
...
CheckMultibandDefoldingGadget::CheckMultibandDefoldingGadget() {
}

CheckMultibandDefoldingGadget::~CheckMultibandDefoldingGadget() {
}

int CheckMultibandDefoldingGadget::process_config(ACE_Message_Block *mb)
{
...
int CheckMultibandDefoldingGadget::process(GadgetContainerMessage<ISMRMRD::AcquisitionHeader> *m1, GadgetContainerMessage<hoNDArray<std::complex<float> > > *m2)
{
    ...
    if (is_parallel)
    {
        ...
        Gadgetron::SaveVectorOntheDisk(tempo, str_home, "Tempo/", "acs_calibration_blipped_",  str_e, str_s,  ".bin");
    ...
    else if (is_acq_single_band )
    {
        ...
        Gadgetron::SaveVectorOntheDisk(tempo, str_home, "Tempo/", "reco_sb_",  str_e, str_s,  ".bin");
    ...
    else if (is_acq_multi_band )
    {
        ...
        //Gadgetron::SaveVectorOntheDisk(tempo, str_home, "Tempo/", "reco_mb_",  str_e, str_s,  ".bin");
...
std::string  CheckMultibandDefoldingGadget::Is_Equal(unsigned int a , unsigned int b)
{
    std::string output;
...
void CheckMultibandDefoldingGadget::get_multiband_parameters(ISMRMRD::IsmrmrdHeader h)
{
...
void CheckMultibandDefoldingGadget::deal_with_inline_or_offline_situation(ISMRMRD::IsmrmrdHeader h)
{
...
GADGET_FACTORY_DECLARE(CheckMultibandDefoldingGadget)
}
