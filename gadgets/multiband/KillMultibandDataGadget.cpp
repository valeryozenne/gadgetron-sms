...
#include "KillMultibandDataGadget.h"
...
KillMultibandDataGadget::KillMultibandDataGadget() {
}

KillMultibandDataGadget::~KillMultibandDataGadget() {
}

int KillMultibandDataGadget::process_config(ACE_Message_Block *mb)
{
...
int KillMultibandDataGadget::process(GadgetContainerMessage<ISMRMRD::AcquisitionHeader> *m1, GadgetContainerMessage<hoNDArray<std::complex<float> > > *m2)
{
...
std::string  KillMultibandDataGadget::Is_Equal(unsigned int a , unsigned int b)
{
    std::string output;
...
void KillMultibandDataGadget::get_multiband_parameters(ISMRMRD::IsmrmrdHeader h)
{
...
void KillMultibandDataGadget::deal_with_inline_or_offline_situation(ISMRMRD::IsmrmrdHeader h)
{
...
GADGET_FACTORY_DECLARE(KillMultibandDataGadget)
}
