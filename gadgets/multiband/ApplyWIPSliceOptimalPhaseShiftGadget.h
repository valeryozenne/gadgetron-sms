#ifndef ApplyWIPSliceOptimalPhaseShiftGadget_H_
#define ApplyWIPSliceOptimalPhaseShiftGadget_H_
...
class EXPORTGADGETSMULTIBAND ApplyWIPSliceOptimalPhaseShiftGadget :
        public Gadget2< ISMRMRD::AcquisitionHeader, hoNDArray< std::complex<float> > >
{
public:
    GADGET_DECLARE(ApplyWIPSliceOptimalPhaseShiftGadget);

    ApplyWIPSliceOptimalPhaseShiftGadget();
    virtual ~ApplyWIPSliceOptimalPhaseShiftGadget();
...
#endif /* ApplyWIPSliceOptimalPhaseShiftGadget_H_ */
