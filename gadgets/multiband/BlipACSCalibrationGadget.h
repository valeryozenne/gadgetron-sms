#ifndef BlipACSCalibrationGadget_H_
#define BlipACSCalibrationGadget_H_
...
class EXPORTGADGETSMULTIBAND BlipACSCalibrationGadget :
        public Gadget2< ISMRMRD::AcquisitionHeader, hoNDArray< std::complex<float> > >
{
public:
    GADGET_DECLARE(BlipACSCalibrationGadget);

    BlipACSCalibrationGadget();
    virtual ~BlipACSCalibrationGadget();
...
#endif /* BlipACSCalibrationGadget_H_ */
