...
#include "CheckWIPMultibandDefoldingGadget.h"
...
CheckWIPMultibandDefoldingGadget::CheckWIPMultibandDefoldingGadget() {
}

CheckWIPMultibandDefoldingGadget::~CheckWIPMultibandDefoldingGadget() {
}

int CheckWIPMultibandDefoldingGadget::process_config(ACE_Message_Block *mb)
{
    ...
    Gadgetron::DeleteTemporaryFiles( str_home, "Tempo/", "debug_*" );
...
int CheckWIPMultibandDefoldingGadget::process(GadgetContainerMessage<ISMRMRD::AcquisitionHeader> *m1, GadgetContainerMessage<hoNDArray<std::complex<float> > > *m2)
{
    ...
    if (is_parallel)
    {
        ...
        //if (slice==0 && e1==64)      {    std::cout << size(tempo) << std::endl;       }
        Gadgetron::SaveVectorOntheDisk(tempo, str_home, "Tempo/", "debug_acs_",  str_e, str_s,  ".bin");
    ...
    else if (is_acq_single_band )
    {
        ...
        Gadgetron::SaveVectorOntheDisk(tempo, str_home, "Tempo/", "debug_sb_",  str_e, str_s,  ".bin");
    ...
    else if (is_acq_multi_band )
    {
        ...
        Gadgetron::SaveVectorOntheDisk(tempo, str_home, "Tempo/", "debug_mb_",  str_e, str_s,  ".bin");
...
std::string  CheckWIPMultibandDefoldingGadget::Is_Equal(unsigned int a , unsigned int b)
{
    std::string output;
...
void CheckWIPMultibandDefoldingGadget::get_multiband_parameters(ISMRMRD::IsmrmrdHeader h)
{
...
void CheckWIPMultibandDefoldingGadget::deal_with_inline_or_offline_situation(ISMRMRD::IsmrmrdHeader h)
{
...
GADGET_FACTORY_DECLARE(CheckWIPMultibandDefoldingGadget)
}
