...
#include "BlipACSCalibrationSimpleGadget.h"
...
BlipACSCalibrationSimpleGadget::BlipACSCalibrationSimpleGadget() {
}

BlipACSCalibrationSimpleGadget::~BlipACSCalibrationSimpleGadget() {
}

int BlipACSCalibrationSimpleGadget::process_config(ACE_Message_Block *mb)
{
...
int BlipACSCalibrationSimpleGadget::process(GadgetContainerMessage<ISMRMRD::AcquisitionHeader> *m1, GadgetContainerMessage<hoNDArray<std::complex<float> > > *m2)
{
...
int BlipACSCalibrationSimpleGadget::get_blipped_factor(int numero_de_slice)
{
...
void BlipACSCalibrationSimpleGadget::get_multiband_parameters(ISMRMRD::IsmrmrdHeader h)
{
...
void BlipACSCalibrationSimpleGadget::deal_with_inline_or_offline_situation(ISMRMRD::IsmrmrdHeader h)
{
...
GADGET_FACTORY_DECLARE(BlipACSCalibrationSimpleGadget)
}
