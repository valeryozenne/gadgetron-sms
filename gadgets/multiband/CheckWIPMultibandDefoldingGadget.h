#ifndef CheckWIPMultibandDefoldingGadget_H_
#define CheckWIPMultibandDefoldingGadget_H_
...
class EXPORTGADGETSMULTIBAND CheckWIPMultibandDefoldingGadget :
        public Gadget2< ISMRMRD::AcquisitionHeader, hoNDArray< std::complex<float> > >
{
public:
    GADGET_DECLARE(CheckWIPMultibandDefoldingGadget);

    CheckWIPMultibandDefoldingGadget();
    virtual ~CheckWIPMultibandDefoldingGadget();
