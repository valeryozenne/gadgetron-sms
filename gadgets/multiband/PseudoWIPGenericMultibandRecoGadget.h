#ifndef PseudoWIPGenericMultibandRecoGadget_H_
#define PseudoWIPGenericMultibandRecoGadget_H_
...
class EXPORTGADGETSMULTIBAND PseudoWIPGenericMultibandRecoGadget :
        public Gadget2< ISMRMRD::AcquisitionHeader, hoNDArray< std::complex<float> > >
{
public:
    GADGET_DECLARE(PseudoWIPGenericMultibandRecoGadget);

    PseudoWIPGenericMultibandRecoGadget();
    virtual ~PseudoWIPGenericMultibandRecoGadget();
    ...
    void preliminary_reshape_unfolded(void);

    arma::cx_fcube im2col_version2_unfolded(void);

    void save_full_kspace(arma::cx_fcube input, unsigned int e1, unsigned int s, std::string name);
...
protected:
    ...
    arma::ivec slice_number_of_mb_acquisition_in_meas_file;
    ...
    //unfolded image
    arma::cx_fcube folded_image_ready;
    arma::cx_fcube folded_image_reshape;
    arma::cx_fcube block_MB;
    ...
    arma::cx_fcube lala;
    arma::cx_frowvec lili;


    // kerel calculation
    arma::cx_fcube missing_data_slice;
    //arma::cx_fmat A;
...
#endif /* PseudoWIPGenericMultibandRecoGadget_H_ */
