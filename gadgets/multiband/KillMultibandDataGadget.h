#ifndef KillMultibandDataGadget_H_
#define KillMultibandDataGadget_H_
...
class EXPORTGADGETSMULTIBAND KillMultibandDataGadget :
        public Gadget2< ISMRMRD::AcquisitionHeader, hoNDArray< std::complex<float> > >
{
public:
    GADGET_DECLARE(KillMultibandDataGadget);

    KillMultibandDataGadget();
    virtual ~KillMultibandDataGadget();
