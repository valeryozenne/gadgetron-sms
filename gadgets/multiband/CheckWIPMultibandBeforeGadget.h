#ifndef CheckWIPMultibandBeforeGadget_H_
#define CheckWIPMultibandBeforeGadget_H_
...
class EXPORTGADGETSMULTIBAND CheckWIPMultibandBeforeGadget :
        public Gadget2< ISMRMRD::AcquisitionHeader, hoNDArray< std::complex<float> > >
{
public:
    GADGET_DECLARE(CheckWIPMultibandBeforeGadget);

    CheckWIPMultibandBeforeGadget();
    virtual ~CheckWIPMultibandBeforeGadget();
