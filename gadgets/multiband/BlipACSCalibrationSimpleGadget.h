#ifndef BlipACSCalibrationSimpleGadget_H_
#define BlipACSCalibrationSimpleGadget_H_
...
class EXPORTGADGETSMULTIBAND BlipACSCalibrationSimpleGadget :
        public Gadget2< ISMRMRD::AcquisitionHeader, hoNDArray< std::complex<float> > >
{
public:
    GADGET_DECLARE(BlipACSCalibrationSimpleGadget);

    BlipACSCalibrationSimpleGadget();
    virtual ~BlipACSCalibrationSimpleGadget();
...
#endif /* BlipACSCalibrationSimpleGadget_H_ */
