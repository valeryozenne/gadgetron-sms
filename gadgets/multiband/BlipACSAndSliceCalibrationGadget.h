#ifndef BlipACSAndSliceCalibrationGadget_H_
#define BlipACSAndSliceCalibrationGadget_H_
...
class EXPORTGADGETSMULTIBAND BlipACSAndSliceCalibrationGadget :
        public Gadget2< ISMRMRD::AcquisitionHeader, hoNDArray< std::complex<float> > >
{
public:
    GADGET_DECLARE(BlipACSAndSliceCalibrationGadget);

    BlipACSAndSliceCalibrationGadget();
    virtual ~BlipACSAndSliceCalibrationGadget();
...
protected:
    ...
    arma::cx_fvec const_phase_1;
    arma::cx_fvec const_phase_2;

    arma::cx_fvec const_shift_1_to_apply_;
    arma::cx_fvec const_shift_2_to_apply_;



};
}
#endif /* BlipACSAndSliceCalibrationGadget_H_ */
