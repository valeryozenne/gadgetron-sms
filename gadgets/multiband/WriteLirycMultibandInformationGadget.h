#ifndef WriteLirycMultibandInformationGadget_H_
#define WriteLirycMultibandInformationGadget_H_
...
class EXPORTGADGETSMULTIBAND WriteLirycMultibandInformationGadget :
        public Gadget2< ISMRMRD::AcquisitionHeader, hoNDArray< std::complex<float> > >
{
public:
    GADGET_DECLARE(WriteLirycMultibandInformationGadget);

    WriteLirycMultibandInformationGadget();
    virtual ~WriteLirycMultibandInformationGadget();
...
protected:
      ...
      GADGET_PROPERTY(Siemens_Reordering, int, "Siemens_Reordering", 0);
      GADGET_PROPERTY(No_Reordering, int, "No_Reordering", 0);
    ...
    arma::ivec guest_order_of_acquisition_mb;
    arma::ivec guest_order_of_acquisition_sb;
