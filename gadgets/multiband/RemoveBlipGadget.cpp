...
RemoveBlipGadget::RemoveBlipGadget() {
}

RemoveBlipGadget::~RemoveBlipGadget() {
}

int RemoveBlipGadget::process_config(ACE_Message_Block *mb)
{
...
int RemoveBlipGadget::process(GadgetContainerMessage<ISMRMRD::AcquisitionHeader> *m1, GadgetContainerMessage<hoNDArray<std::complex<float> > > *m2)
{
   ...
   /* std::ostringstream indice_e1;
    ...
    if (shift_!=0)
    {
        ...
        //std::cout << "undo shift "<< shift_ << " slice  " <<   slice  << std::endl;
...
int RemoveBlipGadget::get_blipped_factor(int numero_de_slice)
{
...
void RemoveBlipGadget::get_multiband_parameters(ISMRMRD::IsmrmrdHeader h)
{
...
void RemoveBlipGadget::deal_with_inline_or_offline_situation(ISMRMRD::IsmrmrdHeader h)
{
...
GADGET_FACTORY_DECLARE(RemoveBlipGadget)
}
