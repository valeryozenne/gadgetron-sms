...
#include "WriteMultibandInformationGadget.h"
...
WriteMultibandInformationGadget::WriteMultibandInformationGadget() {
}

WriteMultibandInformationGadget::~WriteMultibandInformationGadget() {
}

int WriteMultibandInformationGadget::process_config(ACE_Message_Block *mb)
{
...
int WriteMultibandInformationGadget::process(GadgetContainerMessage<ISMRMRD::AcquisitionHeader> *m1, GadgetContainerMessage<hoNDArray<std::complex<float> > > *m2)
{
...
std::string  WriteMultibandInformationGadget::Is_Equal(unsigned int a , unsigned int b)
{
    std::string output;
...
void WriteMultibandInformationGadget::get_multiband_parameters(ISMRMRD::IsmrmrdHeader h)
{
...
void WriteMultibandInformationGadget::deal_with_inline_or_offline_situation(ISMRMRD::IsmrmrdHeader h)
{
...
GADGET_FACTORY_DECLARE(WriteMultibandInformationGadget)
}
