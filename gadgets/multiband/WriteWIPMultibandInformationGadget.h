#ifndef WriteWIPMultibandInformationGadget_H_
#define WriteWIPMultibandInformationGadget_H_
...
class EXPORTGADGETSMULTIBAND WriteWIPMultibandInformationGadget :
        public Gadget2< ISMRMRD::AcquisitionHeader, hoNDArray< std::complex<float> > >
{
public:
    GADGET_DECLARE(WriteWIPMultibandInformationGadget);

    WriteWIPMultibandInformationGadget();
    virtual ~WriteWIPMultibandInformationGadget();
