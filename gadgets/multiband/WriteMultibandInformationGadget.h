#ifndef WriteMultibandInformationGadget_H_
#define WriteMultibandInformationGadget_H_
...
class EXPORTGADGETSMULTIBAND WriteMultibandInformationGadget :
        public Gadget2< ISMRMRD::AcquisitionHeader, hoNDArray< std::complex<float> > >
{
public:
    GADGET_DECLARE(WriteMultibandInformationGadget);

    WriteMultibandInformationGadget();
    virtual ~WriteMultibandInformationGadget();
