...
#include "WriteWIPMultibandInformationGadget.h"
...
WriteWIPMultibandInformationGadget::WriteWIPMultibandInformationGadget() {
}

WriteWIPMultibandInformationGadget::~WriteWIPMultibandInformationGadget() {
}

int WriteWIPMultibandInformationGadget::process_config(ACE_Message_Block *mb)
{
    ...
    std::cout << " lNumberOfStacks_ "<< lNumberOfStacks_ << std::endl;
...
int WriteWIPMultibandInformationGadget::process(GadgetContainerMessage<ISMRMRD::AcquisitionHeader> *m1, GadgetContainerMessage<hoNDArray<std::complex<float> > > *m2)
{
...
std::string  WriteWIPMultibandInformationGadget::Is_Equal(unsigned int a , unsigned int b)
{
    std::string output;
...
void WriteWIPMultibandInformationGadget::get_multiband_parameters(ISMRMRD::IsmrmrdHeader h)
{
    ...
    std::cout <<  " MB_factor_ " << MB_factor_<<  " Blipped_CAIPI_ "<< Blipped_CAIPI_ << std::endl;

}



void WriteWIPMultibandInformationGadget::deal_with_inline_or_offline_situation(ISMRMRD::IsmrmrdHeader h)
{
...
GADGET_FACTORY_DECLARE(WriteWIPMultibandInformationGadget)
}
